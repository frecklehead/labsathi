    ...
    return (
        <div className="flex flex-col items-center gap-2 select-none">
            ...
            <div className="relative w-32 h-36 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 rounded-2xl border-4 border-gray-700 shadow-2xl flex flex-col items-center p-3">
                ...
                {/* Label */}
                <div className="text-[8px] text-gray-400 font-bold tracking-wider mb-1">AMMETER</div>
                ...
                <div className="relative w-full h-24 bg-gradient-to-b from-slate-900 to-black rounded-lg border-2 border-gray-600 overflow-hidden shadow-inner">
                    ...
                    <svg className="w-full h-full" viewBox="0 0 100 80">
                        ...
                        />
                        <circle cx="50" cy="70" r="3" fill="#ef4444" stroke="#7f1d1d" strokeWidth="1" />
                    </svg>
                </div>

                {/* Digital Display - LED style */}
                <div className="mt-2 bg-black px-3 py-1.5 rounded border-2 border-green-900 shadow-inner">
                    <span className="text-green-400 font-mono text-sm font-bold drop-shadow-[0_0_8px_rgba(74,222,128,0.8)]">
                        {current.toFixed(3)} A
                    </span>
                </div>
